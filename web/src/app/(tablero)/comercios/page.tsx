    ...
    <>
      ...
      <div className={estilos.stack}>
        ...
        <div className={estilos.grid2}>
          ...
          >
            <RankingTable id="zonas-peores" titulo="Zonas con mayor devolución" filas={zonasPeores} etiquetaDimension="Zona" />
          </Card>
          ...
          >
            <RankingTable id="zonas-volumen" titulo="Zonas por volumen" filas={zonasVolumen} etiquetaDimension="Zona" />
          </Card>
        </div>
      </div>
    </>
